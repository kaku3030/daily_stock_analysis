Warning: truncated output (original token count: 58991)
Total output lines: 2329
...
- 新增 Web AI 建议页、持仓页 latest active 信号摘要、历史报告信号展示和更完整的信号详情卡片，展示评分、置信度、价格计划、催化、风险与失效条件…28991 tokens truncated…边界、汇率降级行为测试。
