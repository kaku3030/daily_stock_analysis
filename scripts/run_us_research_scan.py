...
def _sync_candidate_pool(payload: dict, output_dir: Path) -> None:
    try:
        ...
        for candidate in candidates:
            ...
            current_pick = pick_map.get(code, {})
            candidate["dsa_news"] = current_pick.get("dsa_news") or []
        ...
        for candidate in candidates:
            ...
            candidate["news_change"] = (
                latest_event.get("change") if isinstance(latest_event, dict) else {}
            )
        ...
        _write_json_markdown(
            ...
            news_radar,
            news_change_radar_markdown(news_radar),
        )
        _write_json_markdown(
            output_dir,
